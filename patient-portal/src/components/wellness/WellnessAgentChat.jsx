...
/**
 * Message input area with voice input support
 */
        ...
        >
            <div className="flex-1 relative">
                <textarea
                    ...
                    className={`w-full px-4 py-2.5 pr-12 border-0 rounded-xl text-sm transition-all resize-none max-h-24 ${isListening
