            ...
            >
                ...
                <motion.div variants={itemVariants} className="mb-8">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-4 -mx-6 px-6 scrollbar-hide snap-x">
                        ...
                        {/* Mock Vitals Cards for Carousel Effect */}
                        <div className="card-premium p-6 min-w-[45%] snap-center flex flex-col justify-between bg-white">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-xs text-slate-400 mt-1">Avg Heart Rate</p>
                            </div>
                        </div>
                        ...
                        <div className="card-premium p-6 min-w-[45%] snap-center flex flex-col justify-between bg-white">
                           <div className="flex justify-between items-start">
                                ...
                                <span className="text-xs text-slate-400 font-medium">8h ago</span>
                            </div>
                            <div className="mt-4">
                                <span className="text-2xl font-bold text-slate-800">85</span>
                                <span className="text-sm text-slate-500 ml-1">%</span>
                                <p className="text-xs text-slate-400 mt-1">Sleep Quality</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
